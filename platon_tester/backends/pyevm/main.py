...
from platon_utils.decorators import replace_exceptions
...
from platon_tester.backends.common import merge_genesis_overrides
...
class PyEVMBackend(BaseChainBackend):
    ...
    def estimate_gas(self, transaction, block_number="latest"):
        ...
        if block_number == "latest":
            ...
            raise NotImplementedError('"pending" block identifier is unsupported in platon-tester')
        else:
            return self.chain.estimate_gas(
                spoofed_transaction,
